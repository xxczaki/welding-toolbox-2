...
import {Linking, ScrollView, View, KeyboardAvoidingView, Platform} from 'react-native';
			...
			<KeyboardAvoidingView enabled style={{flex: 1, flexDirection: 'column', justifyContent: 'center', backgroundColor: '#121212'}} behavior="padding" keyboardVerticalOffset={50}>
				<ScrollView contentContainerStyle={{flexGrow: 1, backgroundColor: '#121212'}} keyboardShouldPersistTaps="handled">
					<List.Section>
						...
						/>
						{Platform.OS === 'ios' && (
							<View style={{display: 'flex', alignItems: 'flex-end', marginTop: -130}}>
								<Picker
									selectedValue={settings?.resultUnit || 'mm'}
									style={{width: '50%'}}
									itemStyle={{color: 'gray'}}
					...
					<Portal>
						<Dialog visible={visible} onDismiss={hideDialog}>
							...
							<Dialog.Content>
								<View style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: 140}}>
									<Controller
										control={control}
