	...
	return (
		<View style={{ flex: 1 }}>
			<Appbar.Header>
				...
				<Appbar.Action
					icon="delete"
					disabled={settings?.resultHistory?.length === 0}
					onPress={() => {
						showDialog();
					}}
				/>
						...
						if (!granted && Platform.OS === 'android') {
							await PermissionsAndroid.request(
								'android.permission.WRITE_EXTERNAL_STORAGE',
								{
									...
									message:
										"Welding Toolbox 2 requires write permission is order to share your result history. If you choose not to grant the app this permission, sharing your result history won't be available.",
			...
			>
				...
				>
					<List.Section>
						{settings?.resultHistory?.length === 0 ||
					...
					<Portal>
						<Dialog visible={visible} onDismiss={hideDialog}>
							...
							<Dialog.Content>
								<Paragraph>
									This action will clear the whole result history and cannot be
									undone.
								</Paragraph>
							</Dialog.Content>
							<Dialog.Actions>
